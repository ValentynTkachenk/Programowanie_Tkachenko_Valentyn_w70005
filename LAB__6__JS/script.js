...
zarzadzanie.dodajPracownika(new Pracownik("Valentyn", "Tkachenko", 6000));
zarzadzanie.dodajPracownika(new Pracownik("Michal", "Sroda", 5000));
console.log(zarzadzanie.listaPracownikow);
zarzadzanie.usunPracownika("Valentyn", "Tkachenko");
console.log(zarzadzanie.listaPracownikow);
